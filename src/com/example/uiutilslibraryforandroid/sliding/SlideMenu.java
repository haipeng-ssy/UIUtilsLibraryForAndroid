...
public class SlideMenu extends ViewGroup {
	...
	public void computeScroll() {
		if (mScroller.computeScrollOffset()) {
			...
			//如果没有达到mScroller.computeScrollOffSet将会一直运行,80%确定，onThouchEvent/onThouch没有触发computeScroll,80%确定
	...
	public void scrollTo(int x, int y) {
		super.scrollTo(x, y);
		postInvalidate();//不在ui线程中刷新ui,非ui线程安全，此方法也可以调用postInvalidate
	}
